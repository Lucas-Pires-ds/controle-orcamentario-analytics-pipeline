...
INTEGRIDADE REFERENCIAL DE CHAVES ESTRANGEIRAS: IDENTIFIQUEI 65 REGISTROS COM CENTRO DE CUSTO NÃO CADASTRADO, SENDO QUE TODOS OS REGISTROS FORAM REALIZADOS COM UM UNICO CENTRO DE CUSTO: O 999.
ESSES REGISTROS REPRESENTAM 1,3% DE IMPACTO FINANCEIRO DO MONTANTE TOTAL.
DADO QUE JÁ DESCARTEI 0,15% REFERENTE AOS REGISTROS SEM DATA, OPTO POR NÃO DESCARTAR ESSES 0,63% QUE TOTALIZARIAM JUNTO AOS REGISTROS ANTERIORMENTE DESCARTADOS, PRATICAMENTE 1%
DE UM MONTANTE DE 138,7 MILHOES. TRATAMENTO: ADICIONAREI NA TABELA "DIM_CENTRO_CUSTO" UM CENTRO DE CUSTO CORINGA PARA LANCAMENTOS COM CENTROS DE CUSTO INVÁLIDOS.

VALORES NEGATIVOS: IDENTIFIQUEI 51 REGISTROS COM VALORES NEGATIVOS. COMO NÃO ESTÃO ATRELADOS A UM STATUS ESPECÍFICO (EX: "CANCELADO" OU "ESTORNADO"), 
...
- INTEGRIDADE DOS VALORES: 6 OUTLIERS ABSURDOS ENCONTRADOS, ACUMULANDO QUASE R$ 1 MI, SUSPEITA DE ERRO DE DIGITAÇÃO. TRATAMENTO: SERÁ CRIADA UMA COLUNA PARA 
